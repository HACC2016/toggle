...
/***/ function(module, exports, __webpack_require__) {
	...
	var Landing = __webpack_require__(129);
	var Search = __webpack_require__(131);
	var Layout = __webpack_require__(130);
	var Details = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexLink2 = __webpack_require__(161);

	var _IndexLink3 = _interopRequireDefault(_IndexLink2);

	var _withRouter2 = __webpack_require__(180);

	var _withRouter3 = _interopRequireDefault(_withRouter2);

	var _IndexRedirect2 = __webpack_require__(162);

	var _IndexRedirect3 = _interopRequireDefault(_IndexRedirect2);

	var _IndexRoute2 = __webpack_require__(163);
	...
	var _Route2 = __webpack_require__(165);

	var _Route3 = _interopRequireDefault(_Route2);

	var _History2 = __webpack_require__(160);

	var _History3 = _interopRequireDefault(_History2);

	var _Lifecycle2 = __webpack_require__(164);

	var _Lifecycle3 = _interopRequireDefault(_Lifecycle2);

	var _RouteContext2 = __webpack_require__(166);
	...
	var _applyRouterMiddleware2 = __webpack_require__(170);

	var _applyRouterMiddleware3 = _interopRequireDefault(_applyRouterMiddleware2);

	var _browserHistory2 = __webpack_require__(171);

	var _browserHistory3 = _interopRequireDefault(_browserHistory2);

	var _hashHistory2 = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reactRedux = __webpack_require__(86);
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(
						'h1',
						{ className: 'title' },
						'DistrictCrimes Search '
					),
					React.createElement(
						'form',
						{ onSubmit: this.gotoSearch },
						React.createElement('input', { value: this.props.searchTerm,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(4);
	var ShowCard = __webpack_require__(132);
	var Header = __webpack_require__(73);
	var _React$PropTypes = React.PropTypes;
	var object = _React$PropTypes.object;
	var string = _React$PropTypes.string;
			...
			return React.createElement(
				...
				React.createElement(
					...
					this.props.route.shows.filter(function (show) {
						...
						return React.createElement(ShowCard, _extends({}, show, { key: index }));
					})
				)
			);
		}
	...
	var ShowCard = function ShowCard(props) {
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'show-card' },
				React.createElement('img', { src: '/img/posters/' + props.poster, className: 'show-card-img' }),
				React.createElement(
					'div',
					...
					React.createElement('img', { src: '/img/posters/' + props.rank, className: 'show-card-img' })
				)
			)
		);
	};
		...
		"shows": [
			{
				...
				"trailer": "cmHPWluzy9M",
				"rank": "bino.jpg",
				"remedy": "Tell us how this Senator is preventing crime and we will post here."
			},
			{
				"title": "Senator Donovan M. Dela Cruz",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "delacruz.jpg",
				"imdbID": "dela_cruz.jpg",
				"trailer": "1oTIrFfNKg8",
				"rank": "vandal.jpg",
				"remedy": "Senator Dela Cruz places high in vandalism. Introduces Senate Resolution 133 Urging the State to Purchase Land from Dole Food Company."
			},
			{
				"title": "Senator J. Kalani English",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "english.jpg",
				"imdbID": "english.jpg",
			...
			{
				"title": "Senator Brickwood Galuteria",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "galu.jpg",
				"imdbID": "galuteria.jpg",
				"trailer": "9XFMbtUUrXo",
				"rank": "vehicletheft.jpg",
				"remedy": "Senator Galuteria wins for the most theft and larceny."
			},
			{
				"title": "Senator Josh Green",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "green.jpg",
				"imdbID": "green.jpg",
			...
			{
				"title": "Senator Lorraine R. Inouye",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "inouye.jpg",
				"imdbID": "inouye.jpg",
			...
			{
				"title": "Senator Gilbert S.C. Keith-Agaran",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "keithagaran.jpg",
				"imdbID": "keithagaran.jpg",
				"trailer": "EsQjF9wR-bQ",
				"rank": "bino.jpg",
				"remedy": "Tell us how this Senator is preventing crime and we will post here."
			},
			...
			{
				"title": "Senator Michelle N. Kidani",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "kidani.jpg",
				"imdbID": "kidani.jpg",
			...
			{
				"title": "Senator Donna Mercado Kim",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "kim.jpg",
				"imdbID": "kim.jpg",
			...
			{
				"title": "Senator Clarence K. Nishihara",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "nishihara.jpg",
				"imdbID": "nishihara.jpg",
				"trailer": "TAFCvizp7-E",
				"rank": "vehicletheft.jpg",
				"remedy": "Senator Nishihara sure has alot of motor vehicle thefts."
			},
			{
				"title": "Senator Gil Riviere",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "riviere.jpg",
				"imdbID": "riviere.jpg",
			...
			{
				"title": "Senator Russell E. Ruderman",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "ruderman.jpg",
				"imdbID": "ruderman.jpg",
			...
			{
				"title": "Senator Maile S.L. Shimabukuro",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "shimabukuro.jpg",
				"imdbID": "shimabukuro.jpg",
				"trailer": "N7peFxGY24c",
				"rank": "burglary.jpg",
				"remedy": "Senator Shimabukuro should maybe keep track of all the burglaries."
			},
			{
				"title": "Senator Sam Slom",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "slom.jpg",
				"imdbID": "slom.jpg",
			...
			{
				"title": "Senator Brian T. Taniguchi",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "taniguchi.jpg",
				"imdbID": "taniguchi.jpg",
				"trailer": "tDwuLhBtN40",
				"rank": "vehiclebreakin.jpg",
				"remedy": "Senator Taniguchi is a leader to having alot of vehicle break-ins and thefts."
			},
			{
				"title": "Senator Laura H. Thielen",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "lthielen.jpg",
				"imdbID": "lthielen.jpg",
				"trailer": "GoPPouI-U94",
				"rank": "bino.jpg",
				"remedy": "Senator Thielen recently introduced a bill to enforce the ban on illegal camping to all public beaches."
			},
			{
				"title": "Senator Jill N. Tokuda",
				"year": "28th Legislature 2016",
				"description": "",
				"poster": "tokuda.jpg",
				"imdbID": "tokuda.jpg",
